<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FaceRecognition.aspx.cs" Inherits="CloudStorage.FaceRecognition" %>
<!DOCTYPE html>
    ...
    <form id="form1" runat="server">
        ...
        <input  type="button" id="btncapture" value="Capture"  />
                ...
                <td align="center" style=" text-align:center;  padding-left:100px">
                    <input type="button" id="abcdbutton" value="Recognize" onclick="abcd()" style="align-content:center;" />
                </td>
                </tr>
            </table>
    </form>
